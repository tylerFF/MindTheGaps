...
const PREDETERMINED_ACTIONS = Object.freeze({
  ...
  'Show rate': [
    { description: 'Send a "what to expect" message (meeting time, length, and prep).',
      helperNarration: 'First, we set expectations so people show up prepared. The action is:',
      owner: 'Admin/CSR', dueDay: 7 },
    ...
    { description: 'Track no-show reasons weekly and make one adjustment each week.',
      helperNarration: 'Now we track why people no-show and fix one cause each week. The action is:',
      owner: 'Owner/GM', dueDay: 45 },
  ...
  'Quote follow-up / decision drop-off': [
    ...
    { description: 'Track quote-to-close weekly and review 3 lost deals for one pattern to fix.',
      helperNarration: 'Now we learn from losses and fix one pattern. The action is:',
      owner: 'Owner/GM', dueDay: 45 },
  ...
  'Rebook/recall gap': [
    { description: 'Choose recall schedule (quarterly / semi-annual / annual).',
      ...
      owner: 'Owner/GM', dueDay: 7 },
    { description: 'At the end of the project or review, ask the client to book their next review now (use a short, standard line).',
    ...
    { description: 'Set up recall reminders based on the service interval (6/12 months): send a short text/email when it\'s time to book.',
      ...
      owner: 'Admin/CSR', dueDay: 21 },
    { description: 'After each project or review, mark whether the next review is booked (Yes/No). If "No," trigger a follow-up step.',
